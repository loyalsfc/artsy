...
function Featured({img}) {
    return (
        <div className='flex border-t border-t-grey border-t-[0.5px] py-[60px] even:flex-row-reverse last:pb-0'>
            <div className="w-1/2 first:mr-[37px] shrink-0 relative view-overlay">
                <div className='absolute left-0 top-0 h-full w-full bg-black/[0.5] text-[2.5rem] font-clash flex justify-center transition-all opacity-0'>
                    <button className="flex items-center text-white">
                        <span className='mr-10'>View  product</span>
            ...
            <article className='w-1/2 flex flex-col justify-between color-grey mr-[50px]'>
                <h4 className='text-[2.5rem] font-bold  font-stix'>The Boolean Egyptian</h4>
                <p className='text-xl'>Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis, lectus magna fringilla urna, porttitor rhoncus dolor pur</p>
                <div className='flex items-center'>
                    ...
                    <p className='font-medium text-xl '>64 major creators</p>
...
function EllipseImage({img}){
    return(
        <div className='h-[51px] w-[51px] inline-block border border-[#78A3AD] rounded-full -ml-[21px]'> 
