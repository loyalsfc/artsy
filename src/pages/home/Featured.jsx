...
function Featured({img}) {
    return (
        <div className='relative flex flex-col md:flex-row border-t border-t-grey border-t-[0.5px] py-8 md:py-[60px] md:even:flex-row-reverse first:border-t-0 md:first:border-t last:border-b border-b-grey border-b-[0.5px]  md:border-b-0'>
            <div className="md:w-1/2 md:first:mr-[37px] shrink-0 relative view-overlay">
                <div className='absolute left-0 top-0 h-full w-full bg-black/[0.5] text-[2.5rem] font-clash flex justify-center transition-all md:opacity-0'>
                    <button className="flex items-end md:items-center text-white mb-6 ml-auto mr-10 md:m-0">
                        <span className='mr-10 hidden md:inline'>View  product</span>
            ...
            <article className='md:w-1/2 flex flex-col justify-between text-grey md:mr-[50px]'>
                <h4 className='text-[30px] md:text-[2.5rem] font-semibold w-full text-center md:text-left md:font-bold font-clash md:font-stix absolute text-white md:text-grey absolute top-12 md:relative md:top-0'>The Boolean Egyptian</h4>
                <p className='text-[15px] md:text-xl mr-9 md:mr-0 text-[#616161] md:text-grey my-4 md:my-0'>Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis, lectus magna fringilla urna, porttitor rhoncus dolor pur</p>
                <div className='flex items-center px-4 md:px-0'>
                    ...
                    <svg className='ml-auto hidden md:block' width="78" height="78" viewBox="0 0 78 78" fill="none" xmlns="http://www.w3.org/2000/svg">
