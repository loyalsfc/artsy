    ...
    return (
        <div className='mt-16 mb-[100px] md:hidden '>
            <div className='relative h-[300px] w-fit mx-auto'>
                <img src={Rectangle240} alt="" className='absolute top-0 left-1/2 -z-10 h-full -translate-x-1/2 -rotate-[9.31deg]'/>
                <img src={Rectangle241} alt="" className='absolute top-0 left-1/2 -z-10 h-full -translate-x-1/2 rotate-[7.75deg]'/>
                <img src={Rectangle242} alt="" className='left-1/2 h-full'/>
