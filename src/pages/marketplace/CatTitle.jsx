...
function CatTitle({title}) {
    return (
        <div onClick={toggleContent} className='cursor-pointer flex items-center justify-between text-black text-xl mb-4 font-medium'>
            <span>{title}</span>
            <svg className='transition-all' width="36" height="29" viewBox="0 0 36 29" fill="none" xmlns="http://www.w3.org/2000/svg">
