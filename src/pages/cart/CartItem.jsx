...
function CartItem({img, name, creator, size, price, qty, handleClick, id, increaseQty, decreaseQty}) {
    ...
    return (
        <div className='border-t border-t-[0.3px] border-t-[#747474] last:border-b-[#747474] last:border-b-[0.3px]  py-6 flex gap-8'>
            <div className="h-[10rem] w-[11rem] overflow-hidden">
                <img src={img} alt="" />
            </div>
            <div className='flex flex-col justify-between'>
                ...
                <span className='text-grey-light'>Size <span className='text-grey-dark'>{size}ft</span></span>
                <div className='text-xl font-medium'>
                    <button onClick={()=>decreaseQty(id)} className='mr-3'>-</button>
                    <span id={id}>{qty}</span>
            ...
            <div className='flex flex-col justify-between ml-auto'>
                ...
                <span className='text-grey-dark text-xl font-cardo'>${price * qty}</span>
            </div>
        </div>
    )
}
