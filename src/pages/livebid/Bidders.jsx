...
function Bidders({classes}) {
    ...
    const variousLikes = [
                    `<svg class='mb-4 absolute bottom-4 md:bottom-0 right-1 md:right-3' width="26" height="21" viewBox="0 0 26 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    `<svg class='mb-4 absolute bottom-4 md:bottom-0 right-1 md:right-3' width="25" height="26" viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    `<svg class='mb-4 absolute bottom-4 md:bottom-0 right-1 md:right-3' width="40" height="33" viewBox="0 0 40 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    `<svg class='mb-4 absolute bottom-4 md:bottom-0 right-1 md:right-3' width="28" height="26" viewBox="0 0 28 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    `<svg class='mb-4 absolute bottom-4 md:bottom-0 right-1 md:right-3' width="38" height="35" viewBox="0 0 38 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    `<svg class='mb-4 absolute bottom-4 md:bottom-0 right-1 md:right-3' width="28" height="27" viewBox="0 0 28 27" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <>
            <div className='h-[calc(100%_-_85.11px)] overflow-y-scroll pb-4' ref={bidContainer}>
                {listOfBidders}
                <div ref={likesContainer} className={'like-container absolute h-2/3 md:h-1/3 ' + classes}>
