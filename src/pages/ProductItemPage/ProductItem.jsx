        ...
        <div>
            <div className="container mx-auto">
                <div className="max-w-[1064px] mx-auto">
                    ...
                    <main className='border  border-grey flex text-grey leading-[97%]'>
                        ...
                        <div className='w-full flex flex-col'>
                            <div className='flex border-b border-b-grey px-5 py-3 justify-between items-center'>
                                <h2 className='text-[2rem] font-bold '>{openProduct && toTitleCase(openProduct.name)}</h2>
                            ...
                            <div className='px-5 py-6 grow-1  '>
                                    <p className='mb-3 text-lg text-[#616161]'>Creator : <span className='text-[#4693ED]'>{openProduct && toTitleCase(openProduct.creator)}</span></p>
                            ...
                            <div className="px-5 mt-auto py-6 flex border-y border-y-grey items-center justify-between rounded-">
                    ...
                    <div className='my-16 flex p-4 shadow-4xl'>
                    ...
                    <section className='flex overflow-x-scroll flex-nowrap gap-9'>
                        {recommendedItems}
                    </section>
                    <Link to="/marketplace">
