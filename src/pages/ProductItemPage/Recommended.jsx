...
function Recommended({img, title, ethprice}) {
    return (
        <div className='w-[350px] border border-grey p-4 flex flex-col gap-2 shrink-0'>
            <svg className='ml-auto' width="53" height="48" viewBox="0 0 53 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M19.075 10C14.0631 10 10 14.0174 10 18.9728C10 27.9456 20.725 36.1027 26.5 38C32.275 36.1027 43 27.9456 43 18.9728C43 14.0174 38.9369 10 33.925 10C30.856 10 28.1417 11.5066 26.5 13.8126C25.6632 12.6341 24.5515 11.6723 23.259 11.0086C21.9665 10.345 20.5314 9.99898 19.075 10Z" stroke="#333333" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
